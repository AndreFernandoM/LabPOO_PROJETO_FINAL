...
public class CarrinhoDAO {
    ...
    public int getQuantCarrinho(int id) {
        try {
            String SQL = "SELECT quantidade FROM tb_carrinho WHERE id_produto=?";
            cmd = con.prepareStatement(SQL);
            cmd.setInt(1, id);
            ...
            System.err.println("Erro ao retornar quantidade do produto no carrinho: " + e.getMessage());
            return 0;
        }
        return 0;
    }
